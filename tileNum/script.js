...
t = trillions[Math.floor(Math.random() * trillions.length)],
...
nv = novemvigintillions[Math.floor(Math.random() * novemvigintllions.length)],
tr = trigintillions[Math.floor(Math.random() * illions.length)],
utr = untrigintillions[Math.floor(Math.random() * trillions.length)];
